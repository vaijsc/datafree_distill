...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:8005 --nproc_per_node=2 diffusion_distillation_dynamic.py \
																							...
																							--log-every 100 \
																							--exp imagenet/dynamic_10000_schedule \
