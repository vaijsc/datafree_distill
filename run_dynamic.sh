...
CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:8005 --nproc_per_node=1 diffusion_distillation_dynamic.py \
																							...
																							--log-every 100 \
																							--exp imagenet/dynamic_20000 \
																							--ckpt ./DiT-XL-2-256x256.pt \
																							--resume_ckpt '04_0020000.pt'
