...
def main(args):
    ...
    experiment_dir = f"x0_align/{args.results_dir}/{args.exp}"  # Create an experiment folder
    ...
    n_iter_to_update_schedule = n_iter // 20
    ...
    for idx in range(start_state, args.nfe-1):
        ...
        for train_steps in tqdm(range(start_iter, n_iter)):
            ...
            with torch.no_grad():
                ...
                z_next_t_teacher = out["pred_xstart"]
            ...
            z0_next_t_student = out["pred_xstart"]
            ...
            if train_steps % n_iter_to_update_schedule == 0 and train_steps <= n_iter_to_update_schedule * 14:
                learning_rate /= 2
                for param_group in opt.param_groups:
                    param_group['lr'] = learning_rate
                if rank == 0:
                    print(f'Learning rate of optimizer in state {args.nfe-idx-1} and step {train_steps + 1} is {learning_rate}')
