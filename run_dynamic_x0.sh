...
CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:8002 --nproc_per_node=1 diffusion_distillation_dynamic_align_x0.py \
																							...
																							--log-every 100 \
																							--exp imagenet/dynamic_10000_1e-2 \
