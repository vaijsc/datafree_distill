...
def main(args):
    ...
    for idx in range(1, args.nfe-1):
        ...
        for train_steps in tqdm(range(1, n_iter + 1)):
            ...
            loss = torch.mean(huber_loss(z0t_next_t_student, z_next_t_teacher) * weight(t) * rescale(t)) + \
                                        torch.mean(huber_loss(z0_next_t_student, z_next_t_teacher) * weight(t) * rescale(t))
