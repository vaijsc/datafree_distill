...
CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --rdzv_endpoint 0.0.0.0:8005 --nproc_per_node=1 diffusion_distillation_regularization.py \
																							--results-dir results_original \
																							--model DiT-XL/2 \
																							--image-size 256 \
																							--num-classes 1000 \
																							--based_iter 2000 \
